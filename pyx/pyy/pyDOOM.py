...
# Using the rich Progress bar
with Progress() as progress:
    task = progress.add_task("[blue]Processing...", total=100)  # Create a task with a total of 100 units
    
    for step in range(100):
        time.sleep(0.05)  # Simulate some work (sleep for 0.05 seconds)
...
# Create weapons
pistol = RangedWeapon("Pistol", damage=30, ammo=15)
shotgun = RangedWeapon("Super-Shotgun", damage=45, ammo=12)
...
# Function to display the game menu and get user input
def main():
    print("pyDoom\n")
    print("made by Ekness\n")
    ...
    while player.hp > 0:
        ...
        while enemy.hp > 0 and player.hp > 0:
            try:
                ...
                print("an instant error occured",e)
                    

if __name__ == "__main__":
    main() # This will start the game when the script is run directly.